...
<link rel="alternate" type="application/json+oembed"
	href="https://www.jotform.com/oembed/?format=json&amp;url=http%3A%2F%2Fwww.jotform.com%2Fform%2F92602202379453"
	title="oEmbed Form">
<link rel="alternate" type="text/xml+oembed"
	href="https://www.jotform.com/oembed/?format=xml&amp;url=http%3A%2F%2Fwww.jotform.com%2Fform%2F92602202379453"
	title="oEmbed Form">
<meta property="og:title" content="PayPal Pro Payment Form">
<meta property="og:url" content="https://form.jotform.me/92602202379453">
<meta property="og:description"
	content="Please click the link to complete this form.">
<meta name="slack-app-id" content="AHNMASS8M">
<link rel="shortcut icon" href="https://cdn.jotfor.ms/favicon.ico">
<link rel="canonical" href="https://form.jotform.me/92602202379453" />
<meta name="viewport"
	content="width=device-width, initial-scale=1.0, maximum-scale=2.0, user-scalable=1" />
<meta name="HandheldFriendly" content="true" />
<title>PayPal Pro Payment Form</title>
<link href="https://cdn.jotfor.ms/static/formCss.css?3.3.12909"
	rel="stylesheet" type="text/css" />
<link type="text/css" media="print" rel="stylesheet"
	href="https://cdn.jotfor.ms/css/printForm.css?3.3.12909" />
<link type="text/css" rel="stylesheet"
	href="https://cdn.jotfor.ms/css/styles/nova.css?3.3.12909" />
<link type="text/css" rel="stylesheet"
	href="https://cdn.jotfor.ms/themes/CSS/566a91c2977cdfcd478b4567.css?themeRevisionID=5d713a7304e9ed3c13620001" />
<style type="text/css">
.form-label-left {
	width: 150px;
}
...
.form-all {
	font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans',
		Verdana, Tahoma, sans-serif, sans-serif;
}
...
.form-label-left, .form-label-right, .form-label-left.form-label-auto,
...
<script src="https://cdn.jotfor.ms/static/jotform.forms.js?3.3.12909"
	type="text/javascript"></script>
...
<body>
	<form class="jotform-form" action="b_add_payment" method="post"
		name="form_92602202379453" id="92602202379453" accept-charset="utf-8">
		<input type="hidden" name="formID" value="92602202379453" /> <input
			...
			<ul class="form-section page-section">
				<li id="cid_1" class="form-input-wide" data-type="control_head">
					<div class="form-header-group ">
						<div class="header-text httal htvam">
							...
							<div id="subHeader_1" class="form-subHeader">Fill required
								details</div>
						</div>
					</div>
				</li>
				<li class="form-line" data-type="control_paypalpro" id="id_3">
					...
					<div id="cid_3" class="form-input">
						<div data-wrapper-react="true" id="paypalpro-payment-wrapper"
							data-paypalpro-currency="USD"
							data-paypalpro-paymentType="product"
							data-paypalpro-sandbox="Disabled">
							<div data-wrapper-react="true">
								...
								<div data-wrapper-react="true">
											...
											<label for="input_3_1001" class="form-product-container">
												<span data-wrapper-react="true"> <span
													class="form-product-name" id="product-name-input_3_1001">
														New Product 1 </span> <span class="form-product-details">
														<b> <span data-wrapper-react="true"> $ <span
									...
									</span> <br /> <br /> <span class="form-payment-total"> <b>
											<span id="total-text"> Total </span>   <span
											class="form-payment-price"> <span
												data-wrapper-react="true"> $ <span id="payment_total">
														0.00 </span>
											</span>
										</span>
									</b>
							...
							<table style="display: none; border: 0" id="creditCardTable"
								...
								<tbody>
										...
										<td width="50%"><span class="form-sub-label-container"
											style="vertical-align: top"> <label
												...
												style="min-height: 13px; margin: 0 0 3px 0"> First
													Name </label> <input type="text" id="input_3_cc_firstName"
										...
										<td width="50%"><span class="form-sub-label-container"
											style="vertical-align: top"> <label
												...
												style="min-height: 13px; margin: 0 0 3px 0"> Last
													Name </label> <input type="text" id="input_3_cc_lastName"
												name="q3_myProducts3[cc_lastName]"
										...
										<td width="50%"><span class="form-sub-label-container"
											style="vertical-align: top"> <label
												...
												style="min-height: 13px; margin: 0 0 3px 0"> Credit
													Card Number </label> <input type="number" id="input_3_cc_number"
												name="q3_myProducts3[cc_number]"
										...
										<td width="50%"><span class="form-sub-label-container"
											style="vertical-align: top"> <label
												...
												style="min-height: 13px; margin: 0 0 3px 0">
													Security Code </label> <input type="number" id="input_3_cc_ccv"
												name="q3_myProducts3[cc_ccv]" class="form-textbox cc_ccv"
									...
									<tr>
										<td width="50%"><span class="form-sub-label-container"
											style="vertical-align: top"> <label
												class="form-sub-label" for="input_3_cc_exp_month"
												id="sublabel_cc_exp_month"
												style="min-height: 13px; margin: 0 0 3px 0">
													Expiration Month </label> <select
										...
										<td width="50%"><span class="form-sub-label-container"
											style="vertical-align: top"> <label
												class="form-sub-label" for="input_3_cc_exp_year"
					...
					<div id="cid_4" class="form-input">
						<div data-wrapper-react="true">
							<span class="form-sub-label-container"
								style="vertical-align: top"> <input type="text"
								id="first_4" name="q4_buyerName[first]" class="form-textbox"
								...
								style="vertical-align: top"> <input type="text"
								id="last_4" name="q4_buyerName[last]" class="form-textbox"
				...
				<li class="form-line" data-type="control_email" id="id_5"><label
					class="form-label form-label-left form-label-auto" id="label_5"
					for="input_5"> Buyer E-mail </label>
					<div id="cid_5" class="form-input">
						<input type="email" id="input_5" name="q5_buyerEmail"
							class="form-textbox validate[Email]" size="32" value=""
				...
				<li class="form-line" data-type="control_address" id="id_6"><label
					...
					for="input_6undefined"> Shipping Address </label>
								...
								<tr>
									<td colSpan="2"><span class="form-sub-label-container"
										style="vertical-align: top"> <input type="text"
											...
											class="form-textbox form-address-line"
											autoComplete="address-line2" size="46" value=""
								...
								<tr>
									<td><span class="form-sub-label-container"
										style="vertical-align: top"> <input type="text"
											...
											autoComplete="address-level2" size="21" value=""
											data-component="city"
											aria-labelledby="label_6 sublabel_6_city" /> <label
											class="form-sub-label" for="input_6_city"
											id="sublabel_6_city" style="min-height: 13px"> City </label>
									</span></td>
									<td><span class="form-sub-label-container"
										style="vertical-align: top"> <input type="text"
											id="input_6_state" name="q6_shippingAddress[state]"
											class="form-textbox form-address-state"
											autoComplete="address-level1" size="22" value=""
											data-component="state"
											aria-labelledby="label_6 sublabel_6_state" /> <label
											class="form-sub-label" for="input_6_state"
											id="sublabel_6_state" style="min-height: 13px"> State
												/ Province </label>
									</span></td>
								</tr>
								<tr>
									<td><span class="form-sub-label-container"
										style="vertical-align: top"> <input type="text"
											...
											autoComplete="postal-code" size="10" value=""
											data-component="zip"
											aria-labelledby="label_6 sublabel_6_postal" /> <label
									...
									<td><span class="form-sub-label-container"
										style="vertical-align: top"> <select
											...
											name="q6_shippingAddress[country]" id="input_6_country"
											data-component="country"
											...
											id="sublabel_6_country" style="min-height: 13px">
												Country </label>
									</span></td>
								</tr>
							</tbody>
					...
					<div id="cid_2" class="form-input-wide">
						<div style="margin-left: 156px" class="form-buttons-wrapper ">
							<button id="input_2" type="submit" class="form-submit-button"
								data-component="button">Submit</button>
						</div>
					</div>
				</li>
		...
		<input type="hidden" id="simple_spc" name="simple_spc"
			value="92602202379453" />
		<script type="text/javascript">
			document.getElementById("si" + "mple" + "_spc").value = "92602202379453-92602202379453";
		</script>
