					...
					<div class="login-content">
						<div class="login-logo">
							<a href="d_login"> <img
								...
								height="150px" width="250px" alt="CoolAdmin">
							</a>
						</div>
						<div class="login-form">
							<form action="d_login_code" method="post">
								...
								<div class="login-checkbox">
									<label> <a href="d_forgot_password">Forgotten Password?</a>
									</label>
								</div>
							...
							<div class="register-link">
								...
								<p>
									Want To Buy Something? <a href="b_login">Shop Now</a>
								</p>
							</div>
						</div>
					</div>
