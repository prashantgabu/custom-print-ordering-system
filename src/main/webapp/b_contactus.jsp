			...
			<div class="address-row">
				<div class="col-md-6 address-left wow fadeInLeft animated"
					...
					<h4 class="wow fadeIndown animated" data-wow-delay=".5s">DROP
						US A LINE</h4>
					<form action="b_contactus_code">
						<input class="wow fadeIndown animated" data-wow-delay=".6s"
							type="text" placeholder="Enter the subject" name="feed_name">
						<input class="wow fadeIndown animated" name="feed_email"
				...
				<div class="col-md-6 address-right">
					<div class="address-info wow fadeInRight animated"
						data-wow-delay=".5s">
						<h4>ADDRESS</h4>
						<p>123 San Sebastian, CG 09-123 Ba,Block(#456),Hill Towers
							4567 New York City USA.</p>
					</div>
					<div class="address-info address-mdl wow fadeInRight animated"
						data-wow-delay=".7s">
						<h4>PHONE</h4>
