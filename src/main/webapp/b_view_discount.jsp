						...
						<table role="presentation" border="0" cellpadding="0"
							...
							<tr>
								<td width="60%" class="logo" style="text-align: center;">
									<ul class="navigation">
										<li><a href="b_index">Home</a></li>
										<li><a href="b_cardlist">Cards</a></li>
										<li><a href="b_bannerlist">Banners And Posters</a></li>
										<li><a href="b_tshirtlist">Printed Clothing</a></li>
										<li><a href="b_otherlist">Others</a></li>
									</ul>
								</td>
							</tr>
						</table>
							...
							<tr>
								<td>
									<div class="text" style="padding: 0 2.5em; text-align: center;">
										<h2>
											We Are Shopping Website That Gives You An Affordable <span>Prices</span>
											&amp; <span>Discount</span>
										</h2>
									</div>
								</td>
														...
														<tr>
															<td class="text-services"
																...
																<div class="heading-section">
																	<h2 style="font-size: 22px;">${dis.design.name}</h2>
																	<p>Category:-${dis.design.subcat.cat.cat_name}
																		Subcategory:-${dis.design.subcat.subcat_name}
																		Discount:-${dis.dis_amt}</p>
											...
											<c:forEach items="${list}" var="dis">
												<td valign="middle" width="50%">
													<table role="presentation" cellspacing="0" cellpadding="0"
														...
														<tr>
															<td><img
																src="<c:url value="/resources/Buyer/images/${dis.design.photo_1}"/>"
																alt="nooo"
						...
						<table>
							<tr>
								<td>
									<div class="text" style="padding: 0 2.5em; text-align: center;">
										<p>
											<a href="b_index" class="btn btn-black-outline">Start
												Shopping</a>
										</p>
									</div>
								</td>
						...
						<table>
							<tr style="text-align: left;">
								...
								<td valign="middle" width="40%"
									...
									<ul class="social">
										<li><img src="images/004-twitter-logo.png" alt=""
											style="width: 24px; max-width: 600px; height: auto; display: block;"></li>
										<li><img src="images/005-facebook.png" alt=""
											style="width: 24px; max-width: 600px; height: auto; display: block;"></li>
										<li><img src="images/006-instagram-logo.png" alt=""
											style="width: 24px; max-width: 600px; height: auto; display: block;"></li>
									</ul>
								</td>
							</tr>
