...
<div class="new">
	...
	<div class="new-info">
		...
		<c:set var="cat_id" scope="session" value="2" />

		<c:forEach items="${list}" var="rev">

			<c:if test="${rev.subcat.cat.cat_id==2}">
				<div
					...
					<div class="new-top">
						...
						<div class="new-text">
							<ul>
								<li><a href="b_single_banner/${rev.design_id}">Quick View
								</a></li>
							</ul>
						</div>
					</div>
					<div class="new-bottom">
						<h5>
							<a class="name" href="b_single_banner/${rev.design_id}">${rev.name}</a>
						</h5>
