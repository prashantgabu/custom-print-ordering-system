			...
			<div class="menu-sidebar__content js-scrollbar1">
				<nav class="navbar-sidebar">
					<ul class="list-unstyled navbar__list">
						...
						<li class="has-sub"><a class="js-arrow"
							href="${pageContext.request.contextPath}/A_view_buyer"> <i
								class="fas fa-copy"></i>Buyers
						</a></li>
						<li class="has-sub"><a class="js-arrow"
							href="${pageContext.request.contextPath}/A_view_feedback"> <i
										...
										<div class="account-dropdown js-dropdown">
											...
											<div class="account-dropdown__body">
												<div class="account-dropdown__item">
													<a
														href="${pageContext.request.contextPath}/A_view_pdesigner">
														<i class="zmdi zmdi-account"></i>Requests
													</a>
												</div>
												<div class="account-dropdown__item">
													<a
														href="${pageContext.request.contextPath}/A_view_feedback">
														<i class="zmdi zmdi-settings"></i>Feedbacks
													</a>
												</div>
											</div>
											<div class="account-dropdown__footer">
												<a href="${pageContext.request.contextPath}/A_logout"> <i
